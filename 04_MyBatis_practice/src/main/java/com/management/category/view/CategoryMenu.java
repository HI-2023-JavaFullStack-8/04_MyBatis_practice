...
public class CategoryMenu {
    ...
    public void displayMenu() {
        ...
        do {
            ...
            switch (selectMenu) {
                ...
                case 4 : categoryController.updateCategoryName(inputModifyCategoryInfo()); break;
                case 5 : categoryController.deleteCategory(inputDeleteCategoryInfo()); break;
                case 9 : System.out.println("========상위 메뉴로 이동합니다.========"); return;
                default : System.out.print("잘못된 번호입니다. 확인 후 다시 입력해 주세요."); break;
            }
    ...
    private static CategoryDTO inputNewCategoryInfo() {
        ...
        System.out.println("===================================");
        System.out.print("신설할 제품분류 정보를 입력하세요.");
        System.out.println("===================================");
    ...
    private static CategoryDTO inputModifyCategoryInfo() {
        ...
        System.out.println("===================================");
        System.out.print("변경 대상 제품분류 코드를 입력해 주세요 : ");
        String categoryCode = sc.nextLine();
        System.out.print("변경할 제품분류명을 입력해 주세요 : ");
        String categoryName = sc.nextLine().toUpperCase();
        System.out.println("===================================");

        CategoryDTO categoryDTO = new CategoryDTO();
        categoryDTO.setCategoryCode(Integer.parseInt(categoryCode));
        categoryDTO.setCategoryName(categoryName);
